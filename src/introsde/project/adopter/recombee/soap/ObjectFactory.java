...
public class ObjectFactory {
    ...
    private final static QName _GetUser_QNAME = new QName("http://soap.recombee.adopter.project.introsde/", "getUser");
    ...
    private final static QName _GetItemRatingResponse_QNAME = new QName("http://soap.recombee.adopter.project.introsde/", "getItemRatingResponse");
    ...
    /**
     * Create an instance of {@link GetItemRatingResponse }
     * 
     */
    public GetItemRatingResponse createGetItemRatingResponse() {
        return new GetItemRatingResponse();
    }
     ...
     * 
     */
    public GetUserRating createGetUserRating() {
        return new GetUserRating();
    }
    ...
    /**
     * Create an instance of {@link GetItemRating }
     * 
     */
    public GetItemRating createGetItemRating() {
        return new GetItemRating();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetUserRating }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://soap.recombee.adopter.project.introsde/", name = "getUserRating")
    public JAXBElement<GetUserRating> createGetUserRating(GetUserRating value) {
        return new JAXBElement<GetUserRating>(_GetUserRating_QNAME, GetUserRating.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetItemRating }{@code >}}
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetUserRatingResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://soap.recombee.adopter.project.introsde/", name = "getUserRatingResponse")
    public JAXBElement<GetUserRatingResponse> createGetUserRatingResponse(GetUserRatingResponse value) {
        return new JAXBElement<GetUserRatingResponse>(_GetUserRatingResponse_QNAME, GetUserRatingResponse.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.recombee.adopter.project.introsde/", name = "getUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.recombee.adopter.project.introsde/", name = "getUser")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetItemRatingResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://soap.recombee.adopter.project.introsde/", name = "getItemRatingResponse")
    public JAXBElement<GetItemRatingResponse> createGetItemRatingResponse(GetItemRatingResponse value) {
        return new JAXBElement<GetItemRatingResponse>(_GetItemRatingResponse_QNAME, GetItemRatingResponse.class, null, value);
    }
